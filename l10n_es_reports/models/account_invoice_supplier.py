...
class ReportAccountInvoicesSuppliers(models.AbstractModel):
    _name = "account.invoices.suppliers"
    _description = _("Invoices Suppliers")
    ...
    def get_templates(self):
        templates = super(ReportAccountInvoicesSuppliers, self).get_templates()
    ...
    def get_lines(self, options, line_id=None):
        ...
        index = 1
        for invoice in self.env['account.invoice'].search([('type', 'in', ['in_invoice', 'in_refund']),
    ...
    def get_report_name(self):
        return _("Invoices Suppliers")

    def format_date(self, dt_to, dt_from, options, dt_filter='date'):
        res = super(ReportAccountInvoicesSuppliers, self).format_date(
